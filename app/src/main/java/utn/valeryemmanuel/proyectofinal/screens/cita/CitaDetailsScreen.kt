...
object CitaDetailsDestination : NavigationDestination {
...
fun CitaDetailsScreen(
    ...
    Scaffold(
        topBar = {
            AgendaTopAppBar(
                title = stringResource(CitaDetailsDestination.titleRes),
...
private fun CitaDetailsBody(
    ...
    Column(
        ...
        CitaDetails(
            cita = itemDetailsUiState.citaDetails.toCita(),
    ...
    Card(
        ...
        Column(
            ...
            CitaDetailsRow(
                ...
                itemDetail = cita.quantity.toString(),
                modifier = Modifier.padding(
                    horizontal = dimensionResource(
                        id = R.dimen
                            .padding_medium
